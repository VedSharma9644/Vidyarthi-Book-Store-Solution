/**
 * Normalize students array from user profile (Firestore / API).
...
/**
 * Payload for checkout / payment / order APIs.
 * @param {{ id: string, name: string, age?: string, gender?: string, schoolLabel?: string, gradeLabel?: string }} student
 */
